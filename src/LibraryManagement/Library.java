...
public static void main(String[] args){
    ...
    public static Connection connect() {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/library", "root", "dhi001");
            return con;
        } catch (Exception ex) {
            ex.printStackTrace();
        }
...
//        loginFrame.setLocationRelativeTo(null);
        ...
        //Setting up the background color of the label.
        l2.setBackground(new Color(102,102,102));
        ...
        usernameTF.setBackground(new Color(102,102,102));
        ...
        //Setting up the background color of the textfield.
        passwordTF.setBackground(new Color(102,102,102));
...
//                          rs.beforeFirst();  //Move the pointer above
                            ...
                            String UID = rs.getString("UID"); //Get user ID of the user
                                if (usertype.equals("1")) { //If boolean value 1
    ...
    public static void librarian_frame() {
        ...
        librarianFrame.setLocation(600, 400);
        ...
        //Setting up the background color of the button.
        view_books_btn.setBackground(new Color(102,102,102));
        ...
        view_books_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                viewBooksFrame.setLocation(600, 300);
                ...
                try {
                    ...
                    book_list.setBackground(new Color(102,102,102));
        ...
        view_users_btn.setBackground(new Color(102,102,102));
        ...
        view_users_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                viewUsersFrame.setLocation(600, 300);
                ...
                try {
                    ...
                    //Setting background colour of the table.
                    users_list.setBackground(new Color(102,102,102));
        ...
        view_issued_books_btn.setBackground(new Color(102,102,102));
        ...
        view_issued_books_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                issuedBooksFrame.setLocation(600, 300);
                ...
                try {
                    ...
                    //Setting background colour of the table
                    issue_book_list.setBackground(new Color(102,102,102));
        ...
        //Setting Background Colour of the button.
        view_returned_books_btn.setBackground(new Color(102,102,102)); //102,102,102
        ...
        view_returned_books_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                returnedBooksFrame.setLocation(600, 300);
                ...
                try {
                    ...
                    //Setting background colour of the table.
                    returned_book_list.setBackground(new Color(102,102,102));
        ...
        //Setting Background Colour of the button.
        add_user_btn.setBackground(new Color(102,102,102));
        ...
        add_user_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                add_user_frame.setLocation(800, 400);
                ...
                add_username_tf.setBackground(new Color(102,102,102));
                ...
                //Setting Background Colour of the textfield.
                add_password_tf.setBackground(new Color(102,102,102));
                ...
                user_type_radio1.setBackground(new Color(102,102,102));
                ...
                //Setting Background Colour of the radiobutton.
                user_type_radio2.setBackground(new Color(102,102,102));
                ...
                //Setting Background Colour of the button.
                user_entry_cancel_btn.setBackground(new Color(51, 51, 51));
        ...
        //Setting Background Colour of the button.
        add_book_btn.setBackground(new Color(102,102,102));
        ...
        add_book_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                book_frame.setLocation(600, 300);
                ...
                //Setting background colour of the label.
                l3.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the label.
                l4.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the label.
                l5.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the label.
                l6.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the label.
                l7.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the textfield.
                book_isbn_tf.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the textfield.
                book_name_tf.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the textfield.
                book_publisher_tf.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the textfield.
                book_edition_tf.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the textfield.
                book_genre_tf.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the textfield.
                book_price_tf.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the textfield.
                book_pages_tf.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the button.
                add_book_cancel_btn.setBackground(new Color(51, 51, 51));
        ...
        //Setting background colour of the button.
        add_issue_book_btn.setBackground(new Color(102,102,102));
        ...
        add_issue_book_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                issue_book_frame.setLocation(700, 350);
                ...
                pickerPanel.setBackground(new Color(102,102,102));
                ...
                l4 = new JLabel("Issued Date(YYYY-MM-DD)", SwingConstants.CENTER);
                ...
                //Setting background colour of the textfield.
                bid_tf.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the textfield.
                uid_tf.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the textfield.
                period_tf.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the button.
                issue_book_cancel_btn.setBackground(new Color(51, 51, 51));
        ...
        //Setting background colour of the button.
        add_return_book_btn.setBackground(new Color(102,102,102));
        ...
        add_return_book_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                returnBookFrame.setLocation(700, 350);
                ...
                //Creating labels.
                JLabel l3 = new JLabel("Return Date(YYYY-MM-DD)", SwingConstants.CENTER);
                ...
                //Setting background colour of the textfield.
                fine_tf.setBackground(new Color(102,102,102));
                ...
                //Setting background colour of the button.
                return_book_btn.setBackground(new Color(51, 51, 51));
                ...
                //Setting background colour of the button.
                cancel_book_btn.setBackground(new Color(51, 51, 51));
                ...
                return_book_btn.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try {
                            ...
                            stmt.executeUpdate("DELETE FROM ISSUED_BOOKS WHERE UID="+uid);
                            //Creating Dialog Box to display message.
    ...
    public static void user_frame(String UID) {
       ...
       studentFrame.setLocation(750, 300);
       ...
       view_books_btn.addActionListener(new ActionListener() {
           ...
           public void actionPerformed(ActionEvent e) {
               ...
               viewBooksUserFrame.setLocation(550, 300);
       ...
       //Setting Background color of the button.
       view_user_issued_books_btn.setBackground(new Color(102,102,102));
       ...
       view_user_issued_books_btn.addActionListener(new ActionListener() {
           ...
           public void actionPerformed(ActionEvent e) {
               ...
               viewUserIssuedBooksFrame.setLocation(400, 200);
               ...
               try {
                   ...
                   //Setting background colour of the table
                   issued_book_list.setBackground(new Color(102,102,102));
       ...
       //Setting Background color of the button.
       view_user_returned_books_btn.setBackground(new Color(102,102,102));
       ...
       view_user_returned_books_btn.addActionListener(new ActionListener() {
           ...
           public void actionPerformed(ActionEvent e) {
               ...
               viewUserReturnedBooksFrame.setLocation(400, 200);
